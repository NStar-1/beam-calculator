...
var app = (function () {
    ...
    /* src/Header/Header.svelte generated by Svelte v3.50.1 */

    const { console: console_1$2 } = globals;
    const file$7 = "src/Header/Header.svelte";
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			button0.textContent = "switch lng wbh";
    			t2 = space();
    			button1 = element("button");
    			button1.textContent = "About us";
    			attr_dev(img, "rel", "icon");
    			if (!src_url_equal(img.src, img_src_value = "/assets/logo.svg")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "icon");
    			attr_dev(img, "class", "AppName svelte-xedwpm");
    			add_location(img, file$7, 51, 8, 1014);
    			attr_dev(button0, "class", "svelte-xedwpm");
    			add_location(button0, file$7, 53, 12, 1151);
    			attr_dev(button1, "class", "svelte-xedwpm");
    			add_location(button1, file$7, 54, 12, 1195);
    			set_style(div0, "flex-direction", "row");
    			set_style(div0, "display", "flex");
    			add_location(div0, file$7, 52, 8, 1090);
    			attr_dev(div1, "class", "ContentHeader svelte-xedwpm");
    			add_location(div1, file$7, 50, 4, 978);
    			attr_dev(div2, "class", "HeaderWrapper svelte-xedwpm");
    			add_location(div2, file$7, 49, 0, 946);
    		},
    ...
    function instance$7($$self, $$props) {
    	...
    	const click_handler = () => console.log('a');
    ...
    /* node_modules/svelte-icon/Icon.svelte generated by Svelte v3.50.1 */

    const file$6 = "node_modules/svelte-icon/Icon.svelte";
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(svg, file$6, 24, 0, 525);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "svelte-tyx2fc");
    			add_location(div, file$5, 113, 0, 3810);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	onMount(() => {
    		console.log(divSize);
    		svg = select("#chart").append("svg").attr("width", "100%").attr('height', "100%").append("g");
    	});
    	...
    	afterUpdate(() => {
    		try {
    			...
    			// Add X axis
    			let x = linear().domain([-1, 6]).range([20, divSize.width - 20]);

    			svg.append("g").attr("transform", `translate(0,${divSize.height - 20})`).call(axisBottom(x));

    			// Add Y axis
    			let y = linear().domain(extent$1(data2, function (d) {
    				return d.y;
    			})).range([divSize.height - 20, 0]);

    			svg.append("g").attr('transform', "translate(20, 0)").call(axisLeft(y));

    			// Add the line
    			svg.append("path").datum(data).attr("fill", "none").attr("stroke", "black").attr("stroke-width", 1.5).attr("d", line().curve(basis).x(function (d) {
    				return x(d.x); // Just add that to have a curve instead of segments
    			}).y(function (d) {
    				return y(d.y);
    			}));

    			svg.append("path").datum(data2).attr("fill", "none").attr("stroke", "red").attr("stroke-width", 1.5).attr("d", line().curve(basis).x(function (d) {
    				return x(d.x); // Just add that to have a curve instead of segments
    			}).y(function (d) {
    				return y(d.y);
    			}));

    			svg.append('image').attr('xlink:href', 'assets/arrow1.svg').attr('x', '100').attr('y', '100');
    			let Tooltip = select("#my_dataviz").append("div").style("height", "100%").style("width", "100%").style("opacity", 0).attr("class", "tooltip").style("background-color", "white").style("border", "solid").style("border-width", "2px").style("border-radius", "5px").style("padding", "5px");
    		} catch(e) {
    			divSize = {}; // d3.svg("/assets/arrow1.svg").then(xml=>{
    		}
    	});
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1$1.warn(`<Graphic> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('divSize' in $$props) divSize = $$props.divSize;
    ...
    /* node_modules/svelte-accessible-accordion/src/Accordion.svelte generated by Svelte v3.50.1 */
    const file$4 = "node_modules/svelte-accessible-accordion/src/Accordion.svelte";
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(ul, file$4, 35, 0, 762);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Accordion extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init$1(this, options, instance$4, create_fragment$4, safe_not_equal, { multiselect: 1 });
    ...
    /* node_modules/svelte-accessible-accordion/src/AccordionItem.svelte generated by Svelte v3.50.1 */
    const file$3 = "node_modules/svelte-accessible-accordion/src/AccordionItem.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$3, 50, 2, 967);
    			...
    			add_location(div, file$3, 70, 2, 1412);
    			set_attributes(li, li_data);
    			add_location(li, file$3, 49, 0, 923);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/Inputs/Input.svelte generated by Svelte v3.50.1 */

    const { console: console_1 } = globals;
    const file$2 = "src/Inputs/Input.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			input = element("input");
    			attr_dev(input, "placeholder", /*title*/ ctx[0]);
    			attr_dev(input, "class", "svelte-330vxp");
    			add_location(input, file$2, 20, 0, 334);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ afterUpdate, title, value });
    	...
    	return [title, value, input_input_handler];
    }
    ...
    class Input extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*title*/ ctx[0] === undefined && !('title' in props)) {
    			console_1.warn("<Input> was created without expected prop 'title'");
    		}
    	}
    ...
    /* src/Options/Options.svelte generated by Svelte v3.50.1 */
    const file$1 = "src/Options/Options.svelte";

    // (75:4) <AccordionItem title="Length">
    function create_default_slot_3(ctx) {
    	let input;
    	let current;

    	input = new Input({
    			props: { title: "type length" },
    			$$inline: true
    		});
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(75:4) <AccordionItem title=\\\"Length\\\">",
    		ctx
    	});
    ...
    // (76:4) <AccordionItem title="Fixation">
    function create_default_slot_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t14 = space();
    			img5 = element("img");
    			attr_dev(div0, "class", "fixationItemTitle svelte-1qd9i3a");
    			add_location(div0, file$1, 78, 16, 1799);
    			attr_dev(input0, "type", "radio");
    			attr_dev(input0, "name", "left");
    			add_location(input0, file$1, 83, 24, 1995);
    			attr_dev(img0, "alt", "strong");
    			if (!src_url_equal(img0.src, img0_src_value = "assets/other/svg (14).svg")) attr_dev(img0, "src", img0_src_value);
    			attr_dev(img0, "class", "svelte-1qd9i3a");
    			add_location(img0, file$1, 84, 24, 2053);
    			attr_dev(div1, "class", "inline svelte-1qd9i3a");
    			add_location(div1, file$1, 82, 20, 1950);
    			attr_dev(input1, "type", "radio");
    			attr_dev(input1, "name", "left");
    			add_location(input1, file$1, 87, 24, 2197);
    			attr_dev(img1, "alt", "strong");
    			if (!src_url_equal(img1.src, img1_src_value = "assets/other/svg (10).svg")) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "class", "svelte-1qd9i3a");
    			add_location(img1, file$1, 88, 24, 2255);
    			attr_dev(div2, "class", "inline svelte-1qd9i3a");
    			add_location(div2, file$1, 86, 20, 2152);
    			attr_dev(input2, "type", "radio");
    			attr_dev(input2, "name", "left");
    			add_location(input2, file$1, 91, 24, 2399);
    			attr_dev(img2, "alt", "strong");
    			if (!src_url_equal(img2.src, img2_src_value = "assets/other/svg (9).svg")) attr_dev(img2, "src", img2_src_value);
    			attr_dev(img2, "class", "svelte-1qd9i3a");
    			add_location(img2, file$1, 92, 24, 2457);
    			attr_dev(div3, "class", "inline svelte-1qd9i3a");
    			add_location(div3, file$1, 90, 20, 2354);
    			attr_dev(form0, "class", "fixationItemContent svelte-1qd9i3a");
    			add_location(form0, file$1, 81, 16, 1895);
    			attr_dev(div4, "class", "fixationItem svelte-1qd9i3a");
    			add_location(div4, file$1, 77, 12, 1756);
    			attr_dev(div5, "class", "fixationItemTitle svelte-1qd9i3a");
    			add_location(div5, file$1, 97, 16, 2633);
    			attr_dev(input3, "type", "radio");
    			attr_dev(input3, "name", "right");
    			add_location(input3, file$1, 102, 24, 2830);
    			attr_dev(img3, "alt", "strong");
    			if (!src_url_equal(img3.src, img3_src_value = "assets/other/svg (14).svg")) attr_dev(img3, "src", img3_src_value);
    			set_style(img3, "transform", "scaleX(-1)");
    			attr_dev(img3, "class", "svelte-1qd9i3a");
    			add_location(img3, file$1, 103, 24, 2889);
    			attr_dev(div6, "class", "inline svelte-1qd9i3a");
    			add_location(div6, file$1, 101, 20, 2785);
    			attr_dev(input4, "type", "radio");
    			attr_dev(input4, "name", "right");
    			add_location(input4, file$1, 106, 24, 3063);
    			attr_dev(img4, "alt", "strong");
    			if (!src_url_equal(img4.src, img4_src_value = "assets/other/svg (10).svg")) attr_dev(img4, "src", img4_src_value);
    			attr_dev(img4, "class", "svelte-1qd9i3a");
    			add_location(img4, file$1, 107, 24, 3122);
    			attr_dev(div7, "class", "inline svelte-1qd9i3a");
    			add_location(div7, file$1, 105, 20, 3018);
    			attr_dev(input5, "type", "radio");
    			attr_dev(input5, "name", "right");
    			add_location(input5, file$1, 110, 24, 3266);
    			attr_dev(img5, "alt", "strong");
    			if (!src_url_equal(img5.src, img5_src_value = "assets/other/svg (9).svg")) attr_dev(img5, "src", img5_src_value);
    			attr_dev(img5, "class", "svelte-1qd9i3a");
    			add_location(img5, file$1, 111, 24, 3325);
    			attr_dev(div8, "class", "inline svelte-1qd9i3a");
    			add_location(div8, file$1, 109, 20, 3221);
    			attr_dev(form1, "class", "fixationItemContent svelte-1qd9i3a");
    			add_location(form1, file$1, 100, 16, 2730);
    			attr_dev(div9, "class", "fixationItem svelte-1qd9i3a");
    			add_location(div9, file$1, 96, 12, 2590);
    			attr_dev(div10, "class", "fixationWrapper svelte-1qd9i3a");
    			add_location(div10, file$1, 76, 8, 1714);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(76:4) <AccordionItem title=\\\"Fixation\\\">",
    		ctx
    	});
    ...
    // (118:4) <AccordionItem title="Title 3">
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(118:4) <AccordionItem title=\\\"Title 3\\\">",
    		ctx
    	});
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Accordion: Accordion$1, AccordionItem: AccordionItem$1, Input });
    	return [];
    }
    ...
    function create_fragment(ctx) {
    	...
    	graphic = new Graphic({ $$inline: true });
    	...
    	const block = {
    		c: function create() {
    			...
    			div6 = element("div");
    			div0 = element("div");
    			div0.textContent = "advertising";
    			t2 = space();
    			div4 = element("div");
    			h1 = element("h1");
    			h1.textContent = "Beam calculator(Title)";
    			t4 = space();
    			p = element("p");
    			p.textContent = "Some description about calculator(Description)";
    			t6 = space();
    			div3 = element("div");
    			div1 = element("div");
    			...
    			t8 = space();
    			div5 = element("div");
    			div5.textContent = "advertising";
    			t10 = space();
    			create_component(input.$$.fragment);
    			attr_dev(div0, "class", "ContentPage ADV svelte-itt10w");
    			add_location(div0, file, 78, 2, 1295);
    			attr_dev(h1, "class", "svelte-itt10w");
    			add_location(h1, file, 80, 3, 1373);
    			attr_dev(p, "class", "svelte-itt10w");
    			add_location(p, file, 81, 3, 1408);
    			attr_dev(div1, "class", "OptionsWrapper svelte-itt10w");
    			add_location(div1, file, 83, 4, 1501);
    			attr_dev(div2, "class", "PictureWrapper svelte-itt10w");
    			add_location(div2, file, 86, 4, 1561);
    			attr_dev(div3, "class", "CalculatorWrapper svelte-itt10w");
    			add_location(div3, file, 82, 3, 1465);
    			attr_dev(div4, "class", "ContentPage svelte-itt10w");
    			add_location(div4, file, 79, 2, 1344);
    			attr_dev(div5, "class", "ContentPage ADV svelte-itt10w");
    			add_location(div5, file, 91, 2, 1638);
    			attr_dev(div6, "class", "InlinePage svelte-itt10w");
    			add_location(div6, file, 77, 1, 1268);
    			attr_dev(div7, "class", "AppWrapper svelte-itt10w");
    			add_location(div7, file, 75, 0, 1230);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			mount_component(header, div7, null);
    			append_dev(div7, t0);
    			...
    			mount_component(graphic, div2, null);
    			append_dev(div6, t8);
    			append_dev(div6, div5);
    			append_dev(div7, t10);
    			mount_component(input, div7, null);
    			current = true;
    		},
    		p: noop$4,
    		i: function intro(local) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Header, Graphic, Options, Input });
    	return [];
    }
