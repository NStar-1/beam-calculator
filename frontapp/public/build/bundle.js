...
var app = (function () {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$2, 51, 8, 1014);
    			attr_dev(button0, "class", "svelte-xedwpm");
    			add_location(button0, file$2, 53, 12, 1151);
    			attr_dev(button1, "class", "svelte-xedwpm");
    			add_location(button1, file$2, 54, 12, 1195);
    			set_style(div0, "flex-direction", "row");
    			set_style(div0, "display", "flex");
    			add_location(div0, file$2, 52, 8, 1090);
    			attr_dev(div1, "class", "ContentHeader svelte-xedwpm");
    			add_location(div1, file$2, 50, 4, 978);
    			attr_dev(div2, "class", "HeaderWrapper svelte-xedwpm");
    			add_location(div2, file$2, 49, 0, 946);
    		},
    ...
    const file$1 = "src/Ggraphic/Graphic.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "svelte-1rvhrpi");
    			add_location(div, file$1, 132, 0, 4573);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	onMount(() => {
    		...
    		svg = select("#chart").append("svg").attr("width", "100%").attr('height', "100%").// .attr('viewBox', '0 0 200 200')
    		append("g");
    	}); // .attr("transform",
    	...
    	afterUpdate(() => {
    		try {
    			...
    			svg.append("svg:defs").append("svg:marker").attr("id", "arrow").attr("refX", 6).attr("refY", 6).attr("markerWidth", 30).attr("markerHeight", 30).attr("orient", "auto").append("path").attr("d", "M 0 0 12 6 0 12 3 6").style("fill", "black");
    			svg.append("line").attr("x1", 100).attr("y1", 100).attr("x2", 100).attr("y2", 50).attr("stroke", "red").attr("stroke-width", 2).attr("marker-end", "url(#arrow)");
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Header, Graphic });
    	return [];
    }
