...
var app = (function () {
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$5, 51, 8, 1014);
    			attr_dev(button0, "class", "svelte-xedwpm");
    			add_location(button0, file$5, 53, 12, 1151);
    			attr_dev(button1, "class", "svelte-xedwpm");
    			add_location(button1, file$5, 54, 12, 1195);
    			set_style(div0, "flex-direction", "row");
    			set_style(div0, "display", "flex");
    			add_location(div0, file$5, 52, 8, 1090);
    			attr_dev(div1, "class", "ContentHeader svelte-xedwpm");
    			add_location(div1, file$5, 50, 4, 978);
    			attr_dev(div2, "class", "HeaderWrapper svelte-xedwpm");
    			add_location(div2, file$5, 49, 0, 946);
    		},
    ...
    const file$4 = "node_modules/svelte-icon/Icon.svelte";
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(svg, file$4, 24, 0, 525);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$3 = "src/Ggraphic/Graphic.svelte";
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$3, 110, 0, 3663);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	afterUpdate(() => {
    		try {
    			...
    			svg.append('image').attr('xlink:href', 'assets/arrow.svg').attr('x', '100').attr('y', '100');
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<Graphic> was created with unknown prop '${key}'`);
    	});
    ...
    const file$2 = "node_modules/svelte-accessible-accordion/src/Accordion.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(ul, file$2, 35, 0, 762);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Accordion extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init$1(this, options, instance$3, create_fragment$3, safe_not_equal, { multiselect: 1 });
    ...
    const file$1 = "node_modules/svelte-accessible-accordion/src/AccordionItem.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$1, 50, 2, 967);
    			...
    			add_location(div, file$1, 70, 2, 1412);
    			set_attributes(li, li_data);
    			add_location(li, file$1, 49, 0, 923);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    // (40:4) <AccordionItem title="Title 1">
    function create_default_slot_3(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(40:4) <AccordionItem title=\\\"Title 1\\\">",
    		ctx
    	});
    ...
    // (41:4) <AccordionItem title="Title 2">
    function create_default_slot_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(41:4) <AccordionItem title=\\\"Title 2\\\">",
    		ctx
    	});
    ...
    // (42:4) <AccordionItem title="Title 3">
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(42:4) <AccordionItem title=\\\"Title 3\\\">",
    		ctx
    	});
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Accordion: Accordion$1, AccordionItem: AccordionItem$1 });
    	return [];
    }
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Header, Graphic, Options });
    	return [];
    }
